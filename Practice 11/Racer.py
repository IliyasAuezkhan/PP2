...
font_coin = pygame.font.SysFont("comicsansms", 20)
...
class Coins(pygame.sprite.Sprite):
    ...
    def respawn(self):
        self.rect.top = 0
        self.rect.center = (random.randint(self.rect.width // 2, SCREEN_WIDTH - self.rect.width // 2), 0)
...
coin_sound = pygame.mixer.Sound('get_coin.wav')
...
while True:
    ...
    amount_coins = font_coin.render(f"Coins: {str(COINS)}", True, BLACK)
