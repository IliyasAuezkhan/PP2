...
class PowerUp(pygame.sprite.Sprite):
    def __init__(self):
        ...
        if self.type == "Nitro": self.image = pygame.image.load("nitro.png").convert_alpha()
        elif self.type == "Shield": self.image = pygame.image.load("shield.png").convert_alpha()
        elif self.type == "Repair": self.image = pygame.image.load("repair.png").convert_alpha()
